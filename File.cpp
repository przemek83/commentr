...
File::File(Common::Source source,
           QString path,
           QString name,
           QString suffix,
           QString* content) :
...
Common::Source File::source() const
{
    return source_;
}

void File::setSource(const Common::Source& source)
{
    source_ = source;
}
...
void File::setBaseName(const QString& baseName)
{
    baseName_ = baseName;
}
...
void File::setSuffix(const QString& suffix)
{
    suffix_ = suffix;
}
