...
void JavaScriptHighlighter::initRules()
{
    ...
    keywordPatterns << "\\break\\b" << "\\bcase\\b" << "\\bcatch\\b"
                    ...
                    << "\\bwhile\\b" << "\\bwith\\b" << "\\bconst\\b"
                    << "\\benum\\b" << "\\bexport\\b" << "\\bextends\\b"
                    << "\\bimport\\b" << "\\bsuper\\b" << "\\babstract\\b"
                    << "\\bboolean\\b" << "\\bbyte\\b" << "\\bchar\\b"
                    << "\\bclass\\b" << "\\bdouble\\b" << "\\bfinal\\b"
                    << "\\bfloat\\b" << "\\bgoto\\b" << "\\bimplements\\b"
                    << "\\bint\\b" << "\\binterface\\b" << "\\blong\\b"
                    << "\\bnative\\b" << "\\bpackage\\b" << "\\bprivate\\b"
